        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <a href="tel:+917009079926" className="text-muted-foreground hover:text-accent transition-colors flex items-center">
                    <Phone className="h-4 w-4 mr-2" />
                    +91 7009079926
                  </a>
                </li>
                <li>
                  <a href="mailto:your-engineer.aryan084@gmail.com" className="text-muted-foreground hover:text-accent transition-colors flex items-center">
                    <Mail className="h-4 w-4 mr-2" />
                    engineer.aryan084@gmail.com
                  </a>
                </li>
                <li className="pt-1">
                  <ResumeButton href="/Aryan's Resume.pdf" text="Resume" />
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-xs">
              &copy; {new Date().getFullYear()} Aryan's Portfolio. All rights reserved.
            </p>
